package src;// This file contains the main() function for the src.Scheduling
...
public class Scheduling {
  ...
  public static void main(String[] args) {
    ...
    if (args.length != 1) {
      System.out.println("Usage: 'java src.Scheduling <INIT FILE>'");
      System.exit(-1);
    }
    File f = new File(args[0]);
    if (!(f.exists())) {
      System.out.println("src.Scheduling: error, file '" + f.getName() + "' does not exist.");
      System.exit(-1);
    }  
    if (!(f.canRead())) {
      System.out.println("src.Scheduling: error, read of " + f.getName() + " failed.");
      System.exit(-1);
    }
    ...
    try {
      ...
      out.println("src.Scheduling Type: " + result.schedulingType);
      out.println("src.Scheduling Name: " + result.schedulingName);
